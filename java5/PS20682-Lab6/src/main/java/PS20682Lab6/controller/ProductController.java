package PS20682Lab6.controller;
...
import PS20682Lab6.dao.ProductDAO;
import PS20682Lab6.entity.Product;
import PS20682Lab6.entity.Report;
import PS20682Lab6.service.SessionService;
...
public class ProductController {
	...
	public String listPrice(Model model) {	
		...
		List<Product> list1 = dao.findByPrice1(100);	
		model.addAttribute("items", list1);	
		return "product/sort";
		
		/*
		List<Product> list2 = dao.findByPrice2(40, Sort.by(Direction.ASC,"price"));	
	...
	public String sort(Model model, 
		...
		List<Product> items = dao.findByPrice2(0,sort);
		model.addAttribute("items", items);
		return "product/sort";
	}
