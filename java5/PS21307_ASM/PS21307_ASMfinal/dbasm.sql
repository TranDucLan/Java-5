...
SET ANSI_PADDING OFF
GO
INSERT [dbo].[Accounts] ([username], [password], [fullname], [email], [photo], [activated]) VALUES (N'hoaitinh', N'123', N'Nguyễn Hoài Tính', N'hoaitinh@gmail.com', N'cat.jpg', 1)
...
INSERT [dbo].[Brands] ([id], [name], [image]) VALUES (N'KE', N'Kẹo', N'keodeo.jpg')
INSERT [dbo].[Brands] ([id], [name], [image]) VALUES (N'BTC', N'Bánh dẻo', N'keodautam.jpg')
INSERT [dbo].[Categories] ([id], [name]) VALUES (N'DM01', N'Bánh')
INSERT [dbo].[Categories] ([id], [name]) VALUES (N'DM02', N'Kẹo dẻo')
INSERT [dbo].[Categories] ([id], [name]) VALUES (N'DM03', N'Bánh dẻo')
...
INSERT [dbo].[ProductCategory] ([id], [productId], [categoryId]) VALUES (6, 0, N'DM01')
INSERT [dbo].[ProductCategory] ([id], [productId], [categoryId]) VALUES (7, 1, N'DM01')
INSERT [dbo].[ProductCategory] ([id], [productId], [categoryId]) VALUES (10, 2, N'DM01')
INSERT [dbo].[ProductCategory] ([id], [productId], [categoryId]) VALUES (40, 3, N'DM01')
INSERT [dbo].[ProductCategory] ([id], [productId], [categoryId]) VALUES (41, 4, N'DM01')
INSERT [dbo].[ProductCategory] ([id], [productId], [categoryId]) VALUES (50, 5, N'DM03')
INSERT [dbo].[ProductCategory] ([id], [productId], [categoryId]) VALUES (52, 6, N'DM01')
INSERT [dbo].[ProductCategory] ([id], [productId], [categoryId]) VALUES (57, 7, N'DM03')
INSERT [dbo].[ProductCategory] ([id], [productId], [categoryId]) VALUES (58, 8, N'DM02')
INSERT [dbo].[ProductCategory] ([id], [productId], [categoryId]) VALUES (59, 9, N'DM02')
INSERT [dbo].[ProductCategory] ([id], [productId], [categoryId]) VALUES (60, 10, N'DM02')
...
INSERT [dbo].[Products] ([id], [name], [price], [createDate], [available], [brandId], [images]) VALUES (2, N'Bánh đậu xanh', 350000, CAST(N'2021-03-20' AS Date), 1, N'BA', N'["banhdauxanh.jpg","banhdauxanh.jpg"]')
INSERT [dbo].[Products] ([id], [name], [price], [createDate], [available], [brandId], [images]) VALUES (3, N'Bánh dừa', 850000, CAST(N'2021-03-20' AS Date), 1, N'BA', N'["banhdua.jpg","banhdua.jpg"]')
INSERT [dbo].[Products] ([id], [name], [price], [createDate], [available], [brandId], [images]) VALUES (4, N'Bánh dừa nướng', 37000, CAST(N'2021-03-22' AS Date), 1, N'BA', N'["banhduanuong.jpg","banhduanuong.jpg"]')
INSERT [dbo].[Products] ([id], [name], [price], [createDate], [available], [brandId], [images]) VALUES (5, N'Bánh nổ dẻo', 322000, CAST(N'2022-04-10' AS Date), 1, N'BTC', N'["banhnodeo.jpg","banhnodeo.jpg"]')
INSERT [dbo].[Products] ([id], [name], [price], [createDate], [available], [brandId], [images]) VALUES (6, N'Bánh rế', 218000, CAST(N'2021-04-15' AS Date), 1, N'BA', N'["banhre.jpg","banhre.jpg"]')
INSERT [dbo].[Products] ([id], [name], [price], [createDate], [available], [brandId], [images]) VALUES (7, N'Cốm dừa', 650000, CAST(N'2021-04-15' AS Date), 1, N'BTC', N'["comdua.jpg","comdua.jpg"]')
INSERT [dbo].[Products] ([id], [name], [price], [createDate], [available], [brandId], [images]) VALUES (8, N'Kẹo dâu dẻo', 1458000, CAST(N'2022-04-12' AS Date), 1, N'KE', N'["keodaudeo.jpg","keodaudeo.jpg"]')
INSERT [dbo].[Products] ([id], [name], [price], [createDate], [available], [brandId], [images]) VALUES (9, N'Kẹo đậu phộng', 189000, CAST(N'2022-04-12' AS Date), 1, N'KE', N'["dauphong.jpeg","dauphong.jpeg"]')
INSERT [dbo].[Products] ([id], [name], [price], [createDate], [available], [brandId], [images]) VALUES (10, N'Kẹo dâu tằm', 350000, CAST(N'2022-04-13' AS Date), 1, N'KE', N'["keodautam.jpg","keodautam.jpg"]')
SET IDENTITY_INSERT [dbo].[Products] OFF
SET IDENTITY_INSERT [dbo].[RoleDetails] ON 

INSERT [dbo].[RoleDetails] ([id], [accountId], [roleId]) VALUES (0, N'admin', N'director')
INSERT [dbo].[RoleDetails] ([id], [accountId], [roleId]) VALUES (4, N'hoaitinh', N'staff')
