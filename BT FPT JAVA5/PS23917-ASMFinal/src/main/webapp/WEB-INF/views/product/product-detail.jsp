							...
							<div class="col-lg-6 col-md-6 col-sm-12 col-12">
								<div class="product-single__meta">
									...
									<div class="product-single__description rte">
										<p>Anh chị em chúng tôi tự ngả Trâu làm thịt gác bếp phục
											vụ các bác, số lượng hạn chế, chất lượng. Sản phẩm của chúng
											tôi có thể cắt miếng không đẹp, màu sắc không ấn tượng như
											sản phẩm sản xuất công nghiệp! Chỉ làm chu đáo số lượng nhỏ,
											để phục vụ các bác an tâm khi sử dụng, và cam kết 3 điều sau:

											Thịt Trâu Tươi, sạch, trâu ăn cỏ, không dịch bệnh Trực tiếp
											chúng tôi hạ trâu, làm thịt, tẩm ướp & gác bếp phục vụ các
											bác Không Sử Dụng Hóa Chất tẩm ướp, bảo quản .</p>
									</div>
									<form method="post" action="http://annimexweb.com/cart/add"
										...
										<div class="product-action clearfix">
											<div class="product-form__item--submit">
												<button ng-click="cart.add(${product.product.id}) "
								...
								<div class="product-info">
									<p class="product-type">
										...
										<c:forEach var="c"
											items="${product.product.productCategories}">
											<a href="/product/list?cid=${c.category.id}" title="Women's">${c.category.name}</a>
									</p>
									</c:forEach>
							...
							<div class="tab-container mb-5">
								<div id="tab1" class="tab-content">
									<div class="product-description rte">
										<p>Ngay sau khi thịt được lấy khỏi giàn sấy, để nguội,
											chúng tôi cho đóng gói và vận chuyển về Hà Nội ngay. Thịt
											Trâu Gác Bếp từ sau khi ra khỏi giàn sấy, rời khỏi bản về đến
											HN chỉ mất 24 đến 26h đồng hồ. Thịt Trâu Gác Bếp của chúng
											tôi không sử dụng bất cứ hóa chất, dung môi bảo quản nào. Nên
											bắt buộc phải đóng gói hút chân không, cách ly với môi trường
											bên ngoài để đảm bảo hàng giao đến tay các bác chất lượng cao
											nhất. Tôi đã đầu tư máy hút chân không, tủ bảo quản chất
											lượng cao để đóng gói..</p>
									</div>
								</div>
							</div>
						</div>
									...
									<div class="col-12 item">
										...
										<div class="product-image">
											...
											<a href="/product/detail/${p.product.id}"> <!-- image -->
												...
												title="${p.product.name}"> <!-- End image --> <!-- Hover image -->
												<img class="hover blur-up lazyload"
												data-src="/images/product/${p.images[1]}"
												src="/images/product/${p.images[1]}" alt="${p.product.name}"
												title="${p.product.name}"> <!-- End hover image -->
											</a>
											<!-- end product image -->
